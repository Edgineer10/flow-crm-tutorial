...
public class PostListView extends VerticalLayout {
    ...
    private void configureGrid() {
        ...
        grid.setSizeFull();
        grid.addColumn(Post::getPostTitle).setHeader("タイトル").setSortable(true);
        grid.addColumn(Post::getPostDesc).setHeader("内容").setSortable(true);
        grid.addColumn(Post::getPostDate).setHeader("日付").setSortable(true);
